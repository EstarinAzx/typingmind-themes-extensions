(function () {
    ...
    mainStyle.textContent = `
        ...
        /* Make sure agent titles are visible */
        .agent-title,
        .agent-name,
        .agent-card h3,
        .agent-card h4,
        ...
        [id*="agent-"] h3,
        [id*="agent-"] h4,
        [data-element-id*="agent"] h3,
        [data-element-id*="agent"] h4,
        [class*="ai-agent"] h3,
        [class*="ai-agent"] h4,
        .agent-item-title,
        .agent-header,
        ...
        /* Ensure agent icons/images have proper contrast */
        .agent-icon,
        .agent-image,
        .agent-avatar,
        .agent-card img,
        ...
        /* Fix any overlays or hover states */
        .agent-card:hover,
        ...
        [data-element-id*="agent"]:hover {
            background-color: ${CONFIG.colors.input.background} !important;
        }
        
        /* Fix intro cards and banner elements */
        .intro-card,
        .banner,
        .announcement,
        [class*="banner-"],
    ...
    const improveTextDisplay = Utils.debounce(
        () =>
            Utils.safe(() => {
                ...
                // Fix AI agent items
                document.querySelectorAll('[class*="agent-"], [id*="agent-"], [aria-label*="agent"], [class*="ai-agent"]').forEach(el => {
                    el.style.backgroundColor = CONFIG.colors.panels;
                    el.style.color = CONFIG.colors.text;
                    el.style.border = `1px solid ${CONFIG.colors.border}`;
                    ...
                    paragraphs.forEach(p => {
                        p.style.color = CONFIG.colors.mutedText;
                    });
                });
            }, 'improveTextDisplay'),
        100
