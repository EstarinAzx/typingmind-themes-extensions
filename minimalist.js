(function () {
    const CONFIG = {
        colors: {
            background: '#F6F3EE',    // Soft beige/cream main background
            text: '#1A1A1A',          // Near black text
            textSecondary: '#4D4D4D', // Darker gray for secondary text
            border: '#E0DCD4',        // Very light beige borders
            input: {
                background: '#FFFFFF', // Pure white input background
                text: '#1A1A1A',       // Near black text
                placeholder: '#767676', // Medium gray placeholder
            },
            button: {
                primary: '#E7E2DB',    // Light beige for buttons
                hover: '#DDD8D0',      // Slightly darker beige on hover
            },
            accent: {
                primary: '#E06A53',    // Coral/orange primary accent
                secondary: '#E8A987',  // Secondary orange accent
                tertiary: '#F6F3EE',   // Soft beige tertiary accent
            },
    ...
    if (!document.getElementById('typingmindSidebarFixMerged')) {
        ...
        sidebarStyle.innerHTML = `
            ...
            [data-element-id="side-bar-background"] textarea:focus { background-color: ${CONFIG.colors.input.background} !important; color: ${CONFIG.colors.text} !important; border-color: ${CONFIG.colors.accent.primary} !important; box-shadow: 0 0 0 2px rgba(224,106,83,0.1) !important; }
            ...
            Utils.safe(() => {
                ...
                globalFix.textContent = `
                    * {
                    ...
                    h1, h2, h3, h4, h5, h6 {
                        font-family: "Inter", "SF Pro Display", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, sans-serif !important;
                    ...
                    /* Clean body text */
                    body {
                        font-family: "Inter", "SF Pro Text", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, sans-serif !important;
    ...
    console.log('Minimalist theme applied with soft beige and coral accent colors');
})();
