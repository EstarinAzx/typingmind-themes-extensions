(function () {
    const CONFIG = {
        colors: {
            ...
            accent: {
                primary: '#7B8C9C',    // Soft blue-gray accent (replacing coral)
                secondary: '#98A7B3',  // Lighter blue-gray for hover states
    ...
    if (!document.getElementById('typingmindSidebarFixMerged')) {
        ...
        sidebarStyle.innerHTML = `
            ...
            [data-element-id="side-bar-background"] textarea:focus { background-color: ${CONFIG.colors.input.background} !important; color: ${CONFIG.colors.text} !important; border-color: ${CONFIG.colors.accent.primary} !important; box-shadow: 0 0 0 2px rgba(123,140,156,0.1) !important; }
            ...
            Utils.safe(() => {
                ...
                globalFix.textContent = `
                    ...
                    *:focus {
                    ...
                    /* Blue-gray accent for strong text */
                    strong, b {
                        color: ${CONFIG.colors.accent.primary} !important;
                        font-weight: 600 !important;
                    }
    ...
    console.log('Minimalist theme applied with soft beige and blue-gray accent colors');
})();
