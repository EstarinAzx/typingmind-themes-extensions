(function () {
    ...
    if (!document.getElementById('typingmindSidebarFixMerged')) {
        ...
        sidebarStyle.innerHTML = `
            ...
            /* Exclusions for AI agents panel */
            .agent-card,
    ...
    mainStyle.textContent = `
        ...
        /* Exclusions for AI agents and Canvas panels */
        .agent-card,
        [data-element-id*="agent"],
        [class*="agent-card"],
        [class*="agent-item"],
        ...
        /* Special handling for role buttons that might get affected */
        div[role="button"]:not([data-element-id*="chat"]):not([data-element-id*="sidebar"]) {
            background-color: initial !important;
            color: initial !important;
        }
            ...
            Utils.safe(() => {
                ...
                globalFix.textContent = `
                    * {
                    ...
                    [class*="bg-gray-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]), 
                    [class*="bg-white"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [class*="border-gray-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    .bg-gray-50:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    .bg-gray-100:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    .bg-white:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) {
                        background-color: ${CONFIG.colors.background} !important;
                        border-color: ${CONFIG.colors.border} !important;
                    }
                    
                    /* Text styles with exceptions for agents */
                    [class*="text-gray-"]:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *),
                    [class*="text-white"]:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *),
                    [class*="text-black"]:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *) {
                        color: ${CONFIG.colors.text} !important;
                    }
                    ...
                    /* Target blue links */
                    .text-blue-500:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *),
                    .text-blue-600:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *),
                    .text-blue-700:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *),
                    a[class*="text-blue-"]:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *),
                    button[class*="text-blue-"]:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *),
                    [class*="text-blue-"]:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *) {
                        color: ${CONFIG.colors.accent.primary} !important;
                    }
                    ...
                    .fixed.bottom-4.right-4 button,
                    .fixed.bottom-0.right-0 button,
                    .bg-blue-500:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    .bg-blue-600:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    .bg-blue-700:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [class*="bg-blue-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    button[class*="bg-blue-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    a[class*="bg-blue-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) {
                        background-color: ${CONFIG.colors.button.primary} !important;
                        color: ${CONFIG.colors.button.text} !important;
                        border: 1px solid ${CONFIG.colors.border} !important;
                        box-shadow: 0 1px 2px rgba(0,0,0,0.02) !important;
                    ...
                    .bg-blue-500:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]):hover,
                    .bg-blue-600:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]):hover,
                    .bg-blue-700:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]):hover,
                    [class*="bg-blue-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]):hover,
                    button[class*="bg-blue-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]):hover,
                    a[class*="bg-blue-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]):hover {
                    ...
                    .bg-blue-500:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    .bg-blue-600:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    button[class*="bg-blue-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    a[class*="bg-blue-"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg * {
                        fill: ${CONFIG.colors.text} !important;
                        stroke: ${CONFIG.colors.text} !important;
                    }
                    
                    /* Make profile picture icon clean and minimal */
                    .rounded-full:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    .rounded-full.bg-blue-500:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    .rounded-full.bg-blue-600:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [data-element-id="workspace-profile-button"] div {
                    ...
                    button.bg-accent-primary:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    a.bg-accent-primary:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    button[style*="background-color: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    a[style*="background-color: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    button[style*="background: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    a[style*="background: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [class*="accent-button"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [class*="accent-bg"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [style*="background-color: #E8DBC5"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [style*="background: #E8DBC5"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) {
                        color: ${CONFIG.colors.text} !important;
                    }
                    
                    button.bg-accent-primary:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    a.bg-accent-primary:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    button[style*="background-color: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    a[style*="background-color: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    button[style*="background: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    a[style*="background: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    [class*="accent-button"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    [class*="accent-bg"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    [style*="background-color: #E8DBC5"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg *,
                    [style*="background: #E8DBC5"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) svg * {
                        fill: ${CONFIG.colors.text} !important;
                        stroke: ${CONFIG.colors.text} !important;
                    }
                    
                    /* Custom accent for important elements */
                    b:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *), 
                    strong:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *) {
                        color: ${CONFIG.colors.text} !important;
                    ...
                    blockquote:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *) {
                    ...
                    table:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *) {
                        border-collapse: collapse !important;
                        width: 100% !important;
                        margin: 1rem 0 !important;
                    }
                    
                    th:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *) {
                        background-color: ${CONFIG.colors.panels} !important;
                        font-weight: 600 !important;
                    ...
                    td:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *) {
                        padding: 0.5rem !important;
                        border-top: 1px solid ${CONFIG.colors.border} !important;
                    }
                    
                    /* Clean focus states */
                    *:focus:not([class*="agent"] *):not([class*="canvas"] *):not([class*="introducing"] *) {
                        outline: 2px solid ${CONFIG.colors.accent.primary} !important;
                        outline-offset: 2px !important;
                    }
                    
                    /* EXCLUSIONS: Don't apply styles to agent cards, canvas, etc. */
                    .agent-card, [data-element-id*="agent"], [class*="agent-card"], [class*="agent-item"], [id*="agent-"], [aria-label*="agent"],
                    [class*="ai-agent"], #agent-section, .agent-section, [id*="ai-agent"], 
                    [class*="canvas-"], [data-element-id*="canvas"], [aria-label*="canvas"], [class*="introducing"], 
                    [class*="agent-list"], [id*="agent-list"], *[style*="border-radius: 12px"],
                    .agent-card *, [data-element-id*="agent"] *, [class*="agent-card"] *, [class*="agent-item"] *, [id*="agent-"] *, [aria-label*="agent"] *,
                    [class*="ai-agent"] *, #agent-section *, .agent-section *, [id*="ai-agent"] *, 
                    [class*="canvas-"] *, [data-element-id*="canvas"] *, [aria-label*="canvas"] *, [class*="introducing"] *, 
                    [class*="agent-list"] *, [id*="agent-list"] *, *[style*="border-radius: 12px"] * {
                    ...
                    /* Preserve styling for any button in an agent section or canvas element */
                    .agent-card button, [data-element-id*="agent"] button, [class*="agent"] button, [class*="canvas"] button, [class*="introducing"] button,
                    ...
                    [style*="background-color: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [style*="background: ${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [style*="background-color:#E8DBC5"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [style*="background:#E8DBC5"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]),
                    [class*="bg-${CONFIG.colors.accent.primary}"]:not([class*="agent"]):not([class*="canvas"]):not([class*="introducing"]) {
                        color: ${CONFIG.colors.text} !important;
                    }
                `;
                ...
                document
                    ...
                    .forEach(msg => {
                        if (
                            ...
                            msg.closest('[class*="agent"]') ||
                            msg.closest('[class*="canvas"]') ||
                            msg.closest('[class*="introducing"]')
                        )
                            return;
                ...
                document
                    ...
                    .forEach(code => {
                        if (!code.closest('.editing') &&
                            !code.closest('[class*="agent"]') &&
                            !code.closest('[class*="canvas"]') &&
                            !code.closest('[class*="introducing"]')
                        )
                ...
                document.querySelectorAll('.bg-blue-500, .bg-blue-600, [class*="bg-blue-"]').forEach(el => {
                    if (
                        ...
                        !el.closest('[class*="introducing"]') &&
                        !el.getAttribute('class')?.includes('agent') &&
                        !el.getAttribute('class')?.includes('canvas') &&
                        !el.getAttribute('class')?.includes('introducing')
                    ) {
                ...
                document.querySelectorAll('.rounded-full').forEach(el => {
                    if (
                        ...
                        !el.getAttribute('class')?.includes('canvas') &&
                        !el.getAttribute('class')?.includes('introducing') &&
                        (el.classList.contains('bg-blue-500') || el.classList.contains('bg-blue-600'))
                    ) {
    ...
    console.log('Minimalist theme applied with soft beige palette and black text on accents, preserving agent cards');
})();
