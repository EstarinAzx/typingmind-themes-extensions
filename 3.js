(function () {
            ...
            Utils.safe(() => {
                ...
                globalFix.textContent = `
                    ...
                    *:focus {
                    ...
                    /* Simplified agents list styling */
                    .agent-card, 
                    .agent-list-item,
                    [class*="agent-card"],
                    [class*="agent-item"],
                ...
                // Fix AI agent items with simplified approach
                document.querySelectorAll('[class*="agent-"], [id*="agent-"], [data-element-id*="agent"], [class*="ai-agent"]').forEach(el => {
    ...
    console.log('Minimalist theme applied with soft beige palette and simplified agent list');
})();
