(function () {
    ...
    if (!document.getElementById('typingmindSidebarFixMerged')) {
        ...
        sidebarStyle.innerHTML = `
            ...
            [data-element-id="tag-search-panel"] .overflow-auto::-webkit-scrollbar-track { background: ${CONFIG.colors.panels} !important; border-radius: 4px !important; }
            ...
            [data-element-id="side-bar-background"] textarea:focus { background-color: ${CONFIG.colors.input.background} !important; color: ${CONFIG.colors.text} !important; border-color: ${CONFIG.colors.text} !important; box-shadow: 0 0 0 2px rgba(58,58,140,0.2) !important; }
            ...
            [data-element-id="workspace-profile-button"]:hover { background-color: rgba(26,26,58,0.3) !important; }
    ...
    mainStyle.textContent = `
        ...
        /* User message bubbles with dark blue background */
        [data-element-id="chat-space-middle-part"] [data-element-id="user-message"] {
            ...
            box-shadow: 0 0 8px rgba(26,26,58,0.3) !important;
        }
        ...
        [data-element-id="chat-space-middle-part"] pre:has(div.relative) {
            ...
            box-shadow: 0 0 10px rgba(26,26,58,0.2) !important;
        }
        ...
        /* Add underwave grid background effect to the main chat area - much more subtle */
        [data-element-id="chat-space-middle-part"]::before {
            ...
            right: 0;
            bottom: 0;
            background-image: linear-gradient(0deg, transparent 24%, rgba(26, 26, 58, 0.03) 25%, rgba(26, 26, 58, 0.03) 26%, transparent 27%, transparent 74%, rgba(26, 26, 58, 0.03) 75%, rgba(26, 26, 58, 0.03) 76%, transparent 77%, transparent), linear-gradient(90deg, transparent 24%, rgba(26, 26, 58, 0.03) 25%, rgba(26, 26, 58, 0.03) 26%, transparent 27%, transparent 74%, rgba(26, 26, 58, 0.03) 75%, rgba(26, 26, 58, 0.03) 76%, transparent 77%, transparent);
            background-size: 50px 50px;
            z-index: -1;
            pointer-events: none;
        }
        
        /* Subtle blue line at the top */
        ...
        /* Add some very subtle horizontal lines */
        ...
        Utils.safe(() => {
            ...
            res = res.replace(
                ...
                (_, lang, code) => {
                    ...
                    return `<pre style="background:#080818; border:1px solid ${
        ...
        () =>
            Utils.safe(() => {
                ...
                globalFix.textContent = `
                    * {
                    ...
                    a[class*="bg-blue-"] {
                        ...
                        color: ${CONFIG.colors.text} !important;
                        border: 1px solid ${CONFIG.colors.border} !important;
                        box-shadow: 0 0 8px rgba(26,26,58,0.2) !important;
                    ...
                    a[class*="bg-blue-"]:hover {
                        background-color: ${CONFIG.colors.button.hover} !important;
                        box-shadow: 0 0 12px rgba(26,26,58,0.3) !important;
                    }
                    ...
                    /* Make profile picture icon stylish but subdued */
                    .rounded-full,
                    ...
                    /* Font for headings - simpler and more understated */
                    h1, h2, h3, h4, h5, h6 {
                    ...
                    [data-element-id="ai-message"] {
                        box-shadow: 0 0 20px rgba(5,5,16,0.05) !important;
                    }
                    ...
                    /* Add a small subtle line below AI responses */
                ...
                document.querySelectorAll('.bg-blue-500, .bg-blue-600, [class*="bg-blue-"]').forEach(el => {
                    ...
                    el.style.boxShadow = '0 0 8px rgba(26,26,58,0.2)';
                });
                
                // Apply styles to the profile icon - more subdued
