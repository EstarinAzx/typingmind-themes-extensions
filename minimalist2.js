(function () {
    const CONFIG = {
        colors: {
            ...
            darkBackground: '#E8E4DD', // Slightly darker shade for panels (from Anthropic)
            ...
            accent: {
                primary: '#E06A53',    // Coral/orange accent (from Anthropic "Powerful" badge)
                secondary: '#E8A987',  // Secondary orange accent
                tertiary: '#F6F3EE',   // Light cream tertiary accent
            },
            card: {
                background: '#E8E4DD', // Card background (from Anthropic)
                border: '#E0DCD4',     // Card border (subtle)
            },
            ...
            Utils.safe(() => {
                ...
                globalFix.textContent = `
                    * {
                    ...
                    blockquote {
                        border-left: 3px solid ${CONFIG.colors.border} !important;
                        padding-left: 16px !important;
                        margin: 16px 0 !important;
                        color: ${CONFIG.colors.mutedText} !important;
                    }
                    
                    /* Add accent styling for links */
                    a {
                    ...
                    button:focus, a:focus, input:focus, textarea:focus {
                        outline: none !important;
                        box-shadow: 0 0 0 2px rgba(224, 106, 83, 0.2) !important;
                    }
