(function () {
    ...
    if (!document.getElementById('typingmindSidebarFixMerged')) {
        ...
        sidebarStyle.innerHTML = `
            ...
            body > div, #__next > div, #root > div { /* Apply base background broadly */
                background-color: ${CONFIG.colors.background} !important;
                color: ${CONFIG.colors.text} !important; /* Ensure base text color */
            }
            [data-element-id="workspace-bar"],
            [data-element-id="side-bar-background"],
            [data-element-id="sidebar-beginning-part"],
            [data-element-id="sidebar-middle-part"],
            [data-element-id="sidebar-end-part"] { /* Ensure end part matches */
                 background-color: ${CONFIG.colors.background} !important; 
            }
    ...
    // Corrected inputStyle.textContent
    inputStyle.textContent = `
        [data-element-id="chat-space-end-part"] { /* Target the container */
            background-color: ${CONFIG.colors.background} !important;
        }
    ...
    // multiStepParse remains the same as the previous correct version
    ...
    // processMessageContent remains the same
    ...
    // styleUserMessageEl remains the same
    ...
    // handleJsonCodeBlock remains the same
    ...
    // styleSandboxOutputs remains the same
    ...
    // improveTextDisplay remains the same
    ...
    // Event listeners and MutationObserver remain the same
