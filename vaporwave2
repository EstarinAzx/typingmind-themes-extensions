(function () {
    ...
    if (!document.getElementById('typingmindSidebarFixMerged')) {
        ...
        sidebarStyle.innerHTML = `
            ...
            [data-element-id="side-bar-background"] textarea:focus { background-color: ${CONFIG.colors.input.background} !important; color: ${CONFIG.colors.text} !important; border-color: ${CONFIG.colors.text} !important; box-shadow: 0 0 0 2px rgba(255,0,255,0.2) !important; }
            ...
            [data-element-id="workspace-profile-button"]:hover { background-color: rgba(255,0,255,0.15) !important; }
    ...
    mainStyle.textContent = `
        ...
        /* Fix main content sections - code blocks with darker purple */
            ...
            Utils.safe(() => {
                ...
                globalFix.textContent = `
                    * {
                    ...
                    .fixed.inset-0,
                    .absolute.inset-0 {
                        background-color: rgba(26,10,36,0.8) !important;
                    }
    ...
    console.log('Vaporwave theme applied with deep purple, magenta, and neon pink aesthetics');
})();
