(function () {
    ...
    mainStyle.textContent = `
        ...
        /* Target the blue user icon in top right */
        .rounded-full.bg-blue-500,
        .rounded-full.bg-blue-600,
        [data-element-id="workspace-profile-button"],
        [data-element-id="workspace-profile-button"] > div,
        .h-8.w-8.rounded-full.bg-blue-500,
        [class*="rounded-full bg-blue-"] {
            background-color: #00AA00 !important;
            border: 1px solid #00FF00 !important;
        }
        
        /* Target blue buttons at bottom right */
        ...
        /* Ensure all SVG icons in these buttons are green */
        ...
        /* Target any remaining blue elements */
        ...
        /* Ensure share buttons and interaction buttons are green */
        [data-element-id="share-button"],
        [data-element-id="interaction-button"],
        ...
        /* Target blue action buttons in the UI */
    ...
    inputStyle.textContent = `
        ...
        /* Bottom right buttons - fix blue */
        .fixed.bottom-4.right-4 > div > button,
        .fixed.bottom-4.right-4 > div > a {
            background-color: #004400 !important;
            color: #00FF00 !important;
            border: 1px solid #00AA00 !important;
        }
        
        .fixed.bottom-4.right-4 > div > button svg,
        .fixed.bottom-4.right-4 > div > a svg {
            color: #00FF00 !important;
            fill: #00FF00 !important;
            stroke: #00FF00 !important;
        }
            ...
            Utils.safe(() => {
                ...
                globalFix.textContent = `
                    * {
                    ...
                    /* Specific targeting for buttons in the footer */
                    .fixed.bottom-4.right-4 button,
                    .fixed.bottom-0.right-0 button {
                        background-color: #004400 !important;
                        border: 1px solid #00AA00 !important;
                ...
                // Target blue elements that might be added dynamically
                ...
                // Target profile icons specifically
    ...
    console.log('Matrix theme applied: typingmind-custom-with-sidebar.js loaded with enhanced fixes for all blue elements.');
})();
